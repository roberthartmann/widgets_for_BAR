        ...
        for unitID, current_unit_BP in pairs(builderUnits) do
            ...
            if foundActivity == true then -- foundBuildingWish == true
                ...
                if builtUnitID then
                    ...
                    totalStallingE = totalStallingE + cost[buildingUnitDefID].EperBP * currrently_unproductive_BP
                    totalStallingM = totalStallingM + cost[buildingUnitDefID].MperBP * currrently_unproductive_BP
